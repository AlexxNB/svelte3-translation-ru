...
* Основной дизайн
  * Двухпанельный дизайн макета
  * Первая панель показывает активные задачи и позволяет добавить новые задачи
  * Вторая вкладка содержит список завершенных задач
* Основная функциональность
  ...
  * Удаление задачи: при нажатии активной или завершенной задачи открывается диалоговое окно с параметрами
* Дополнительный дизайн
  * Стилизация элементов input и button при добавлении задачи
  * Стилизация панелей
  * Стилизация активных задач
  * Стилизация завершенных задач
