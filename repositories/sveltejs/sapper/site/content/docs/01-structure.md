...
> Основное предназначение сервис-воркера — кеширование файлов из папки static. Если в этой папке находится более 50мб файлов, в некоторых браузерах можно упереться в лимит кеша для сервис-воркера, что приведет к прекращению его загрузки. В такой ситуации рекомендуется самостоятельно настроить в файле серви-воркера, какие файлы необходимо кешировать, а какие нет.
