...
Кроме того, потребуется настроить ваш редактор кода, чтобы он подсвечивал синтаксис `.svelte` файлов. Если вы используете VS Code, установите [расширение Svelte](https://marketplace.visualstudio.com/items?itemName=svelte.svelte-vscode), для других редакторов [прочитайте это руководство](blog/setting-up-your-editor).
