...
При первом запуске Sapper, он создаст дополнительный каталог `__sapper__`, содержащий сгенерированные файлы.
...
Это обычное Express (или [Polka](https://github.com/lukeed/polka), etc) приложение, с тремя обязательными требованиями:
...
Этот файл является шаблоном для ответов с сервера. ПредварительноЮ Sapper будет внедрять контент, заменяющий следующие теги:
